        ...
        <PageSection fullWidth margin=''>
          <div className=' border-b-[1.2px] border-gray-400/20 w-full pb-8 flex-col'>
            ...
            <div className="flex-col items-center mt-6 gap-x-1">
              ...
              <span className='px-2 py-1 text-[12px] md:text-sm font-semibold tracking-tight rounded-lg bg-red-400/20 text-rose-700'>SOLD</span>
            </div>
            ...
            <div className="flex-col items-center mt-6 gap-x-1">
              ...
              <span className="flex items-center tracking-tight text-blue-800 gap-x-1 group">
                <a href="/" target={'_blank'} className="line-through transition-colors duration-200 ease-in-out group-hover:text-blue-400">View Project </a>
