        ...
        <>
            ...
            <PageContainer>
                <PageSection fullWidth>
                    ...
                    <p className='mb-6 tracking-tight text-gray-600 text-inter md:text-md'>To recruiters: I am <JobSearchStatus status={'not-searching'} />. To everyone else: feel free to get in touch about anything! Always happy to chat :)</p>
