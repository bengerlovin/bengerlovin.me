        ...
        <div className='relative items-start w-full max-w-3xl pt-8 mx-auto'>
          ...
          <div className='grid grid-cols-2 md:grid-cols-3 max-w-3xl pb-6 pt-9 gap-y-2 md:gap-y-3 '>
            ...
            <div className='flex items-center gap-x-1.5 group'>
              <a href='/resume.pdf' download className='font-inter tracking-tight text-gray-600 group-hover:text-blue-800 transition-colors duration-150 ease-in-out text-base'>!Résumé</a>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-[18px] w-[18px] group-hover:text-blue-800 transition-colors duration-150 ease-in-out" fill="none" viewBox="0 0 24 24" stroke="currentColor">
