            ...
            <ul className="relative">
                ...
                <li className="timeline-list-item">
                    <TimelineItem title="Pursuing Chemistry" date="May 2019">
                        <Text classes="mb-2">I'm accepted into a prestigious pharmaceutical intership at Merck's headquarters in Kennilworth. I pack my bags and move to New Jersey for the summer of 2019. </Text>
                        ...
                        <Text classes="mb-3"> I get to work with incredible chemists at Merck in their Drug Discovery division, and meet withseveral professors in New York whose labs I plan on applying in the fall to for PhD programs.</Text>
                ...
                <li className="timeline-list-item">
                    <TimelineItem title="Deciding Against A PhD" date="September 2019">
                        ...
                        <Text classes="mb-3"> I decide to give myself a year to pursue tech as an alternative and see if I like working as a developer more than chemistry.</Text>
                ...
                <li className="timeline-list-item">
                    <TimelineItem title="Starting My First Developer Role" date="May 2020">
                        ...
                        <Text classes="mb-3">I was hired to help build the new version of my company's software, meaning a new tech stack (Vue.js and Java) and a completely refreshed UI. Full-stack paradise! </Text>
                ...
                <li className="timeline-list-item">
                    <TimelineItem title="Moving Forward With Tech And Sharing What I Know" date="May 2021">
                        ...
                        <div className="flex flex-col w-full py-2 mt-4 mb-5 shadow-soft-small md:p-2">
